...
const Login = () => {
  ...
  return (
    <form onSubmit={submitHandle}>
      <input type='text' placeholder='아이디' onChange={idChangeHandle} value={id} />
      <input type='password' placeholder='비밀번호' onChange={pwChangeHandle} value={pw} />
...
const Login = () => {
  ...
  return (
    <form onSubmit={submitHandle}>
      <input type='text' placeholder='아이디' onChange={idChangeHandle} value={id} ref={idRef} />
      <input type='password' placeholder='비밀번호' onChange={pwChangeHandle} value={pw} ref={pwRef}/>
      <input type='submit' value="로그인" onClick={loginHandle} />
    </form>
  )
}
